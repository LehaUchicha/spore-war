package com.course.game.background;
...
public class BackgroundFXRenderer {
	...
	Array<com.course.game.background.Debris> debrises = new Array<com.course.game.background.Debris>();
