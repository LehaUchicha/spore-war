...
public class Resources {
	...
	public Sprite playButton = new Sprite(new Texture(Gdx.files.internal("data/sprites/playbutton.png")));
	public Sprite food = new Sprite(new Texture(Gdx.files.internal("data/sprites/food.png")));
	public Sprite weapon = new Sprite(new Texture(Gdx.files.internal("data/sprites/weapon.png")));
	public Sprite enemy = new Sprite(new Texture(Gdx.files.internal("data/sprites/enemy.png")));
	...
	public Sprite factoryP1 = atlas.createSprite("vir1");
	public Sprite factoryP2 = atlas.createSprite("vir2");
	public Sprite factoryP3 = atlas.createSprite("vir3");
	public Sprite factoryP4 = atlas.createSprite("vir4");
	...
	public Sprite background2 = atlas.createSprite("background");
	...
	public Sprite singleGame = atlas.createSprite("singleGame");
	public Sprite player = atlas.createSprite("player");
	public Sprite multiplayer = atlas.createSprite("multiplayer");
	...
	public void reInit() {
		...
		factoryP1 = new Sprite(new Texture(Gdx.files.internal("data/sprites/vir1.png")));
		factoryP2 = new Sprite(new Texture(Gdx.files.internal("data/sprites/vir2.png")));
		factoryP3 = new Sprite(new Texture(Gdx.files.internal("data/sprites/vir3.png")));
		factoryP4 = new Sprite(new Texture(Gdx.files.internal("data/sprites/vir4.png")));
		...
		singleGame = new Sprite(new Texture(Gdx.files.internal("data/sprites/singleGame.png")));
		player = new Sprite(new Texture(Gdx.files.internal("data/sprites/vir2.png")));
		multiplayer = new Sprite(new Texture(Gdx.files.internal("data/sprites/multiplayer.png")));
		background2 = new Sprite(new Texture(Gdx.files.internal("data/sprites/background.png")));
